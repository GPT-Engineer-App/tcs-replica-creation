...
**Project**: tcs-replica-creation 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a replica of this page: https://www.tcs.com/ 
...
```sh
git clone https://github.com/GPT-Engineer-App/tcs-replica-creation.git
cd tcs-replica-creation
npm i
